...
namespace MagicLeap.MRTK.Utilities
{
    ...
    public class MeshTexturedWireframeAdapter : MonoBehaviour
    {
        ...
        void Awake()
        {
            ...
            MagicLeapSpatialMeshObserver observer = CoreServices.GetSpatialAwarenessSystemDataProvider<IMixedRealitySpatialAwarenessMeshObserver>() as MagicLeapSpatialMeshObserver;

            _meshingSubsystemComponent = observer.GetActiveMeshingComponent();
